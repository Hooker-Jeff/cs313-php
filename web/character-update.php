...
<html>
	...
	<input type="text" id="char_name" name="char_name" value="<?php foreach ($rows as $row)echo $row['character_name'];?>" width="40%"></input>
	<label for="char_name">Character Name</label>
	<br /><br />

	<input type="text" id="player_name" name="player_name" value="<?php foreach ($rows as $row)echo $row['player_name'];?>" width="40%"></input>
	<label for="player_name">Player Name</label>
	<br /><br />

	<input type="number" id="race_id" name="race_id" min="10" max="18" value="<?php foreach ($rows as $row)echo $row['local_race_id'];?>" width="40%"></input>
	...
	<input type="number" id="class_id" name="class_id" min="20" max="31" value="<?php foreach ($rows as $row)echo $row['local_class_id'];?>" width="40%"></input>
	...
	<input type="number" id="alignment_id" name="alignment_id" min="40" max="48" value="<?php foreach ($rows as $row)echo $row['local_alignment_id'];?>" width="40%"></input>
	...
	<input type="text" id="char_level" name="char_level" value="<?php foreach ($rows as $row)echo $row['char_level'];?>" width="40%"></input>
	<label for="char_level">Character Level</label>
	<br /><br />

	<input type="text" id="exp" name="exp" value="<?php foreach ($rows as $row)echo $row['xp'];?>" width="40%"></input>
	<label for="exp">Current Experience Points</label>
	<br /><br />
	
	<input type="text" id="max_hp" name="max_hp" value="<?php foreach ($rows as $row)echo $row['hp_max'];?>" width="40%"></input>
	<label for="max_hp">Maximum HP</label>
	<br /><br />

	<input type="text" id="current_hp" name="current_hp" value="<?php foreach ($rows as $row)echo $row['hp_current'];?>" width="40%"></input>
